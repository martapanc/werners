		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="box box-info">
					...
					<div class="box-body">
						<div class="table-responsive">
							<table id="res-table" data-toggle="table" data-url="../reservation" data-method="post" data-query-params='action=list'
								data-content-type="application/x-www-form-urlencoded" data-striped="true" data-pagination="true"
								data-pagination-loop="true" data-page-size="10" data-resizable="false" data-sort-name="id" 
				...
				<div class="box box-warning">
					...
					<div class="box-body">
						<div class="table-responsive">
							<table id="ta-table" data-detail-view="true" data-striped="true" data-url="../takeaway" data-method="post"
