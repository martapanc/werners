		...
		<div class="content-wrapper">
			...
			<div class="row invoice-info">
				<div class="col-sm-4 invoice-col">
					...
					<h4>
						<strong>${map.get("title")}</strong> &ensp; ${map.get("firstname")} ${map.get("lastname")} <br> 
				...
				<div class="col-sm-4 invoice-col">
					...
					<h4>
						<strong>Date:</strong> &ensp; ${map.get("date")}<br> 
						<strong>Time:</strong> &ensp; ${map.get("time")}<br>
						<strong>Number of guests: </strong>&ensp; ${map.get("guests")}<br>
					</h4>
				</div>
				<!-- /.col -->
				<div class="col-sm-4">
					...
					<img src="/restaurantProject/dist/img/credit/mestro.png" alt="Maestro">
					<img src="/restaurantProject/dist/img/credit/american-express.png" alt="American Express"> 
					<img src="/restaurantProject/dist/img/credit/cash.ico" height="45" alt="Cash">
				</div>
			</div>
			<!-- /.row --> <!-- Table row -->
