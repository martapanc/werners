...
<title>WPB | Food Categories</title>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Create new Food Category</h4>
					</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Delete Food Category(s)</h4>
					</div>
					...
					<div class="col-md-12">
						<div class="box box-primary">
							<div class="box-body table-responsive">
								...
								<table id="table" data-toggle="table" data-url="../../foodClass" data-method="post"
									...
									data-resizable="true" data-show-toggle="true" data-toolbar=".toolbar" data-show-export="true" data-page-size="20">
									<thead>
										<tr>
