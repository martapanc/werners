...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<a href="/"><b>Werner's</b>Panini&amp;Burgers</a>
		</div>
		<!-- /.login-logo -->
		<div class="login-box-body">
			<p class="login-box-msg">Sign in to your personal account</p>
			<c:if test="${message != null}">
   				<div class="alert alert-danger text-center" id="message-div">${message}</div>
			</c:if>
			...
			<a href="registerForm.jsp" class="text-center">Create a New Account</a><br>
