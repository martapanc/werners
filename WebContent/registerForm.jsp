			...
			<form action="${pageContext.request.contextPath}/register" method="post" data-toggle="validator">
				...
				<p>Choose Avatar</p>
					<select class="image-picker text-center" name="avatar">
  						<option data-img-src="dist/img/avatar1.png" data-img-class="first" data-img-alt="Page 1" value="${pageContext.request.contextPath}/dist/img/avatar1.png" selected></option>
  						<option data-img-src="dist/img/avatar2.png" data-img-alt="Page 2" value="${pageContext.request.contextPath}/dist/img/avatar2.png"></option>
  						<option data-img-src="dist/img/avatar3.png" data-img-alt="Page 3" value="${pageContext.request.contextPath}/dist/img/avatar3.png"></option>
  						<option data-img-src="dist/img/gusteau160x160.jpg" data-img-alt="Page 4" data-img-class="last" value="${pageContext.request.contextPath}/dist/img/gusteau160x160.jpg"></option>
					</select>
				</div>
				<div class="row">
					<div class="col-xs-8">
